...
export const tokens = {
  color: {
    ...
    statusAttention: '#96680A',
    statusAttentionBg: 'rgba(181,134,10,0.10)',
    ...
    brandGreen: '#3D9B6B',
    brandBlue: '#4FA3C7',
    brandGradient: 'linear-gradient(135deg, #3D9B6B 0%, #4FA3C7 100%)',
    brandShadow: '0 2px 12px rgba(61,155,107,0.22)',
