...
export const ATHLETES: AthleteProfile[] = [
  ...
  },
  {
    ...
    position: 'Forward',
    avatarInitials: 'SR',
    avatarCrop: { centerX: 768, centerY: 269, size: 368 },
  ...
  },
  {
    ...
    position: 'Defender',
    avatarInitials: 'PS',
    avatarCrop: { centerX: 1230, centerY: 269, size: 368 },
    cycleRegularity: 'Regular',
  ...
  },
  {
    ...
    position: 'Goalkeeper',
    avatarInitials: 'ET',
    avatarCrop: { centerX: 306, centerY: 750, size: 368 },
    cycleRegularity: 'Regular',
    trainingBackground: 'Elite',
    sleepVariability: 'Low',
    onboardingComplete: true,
  },
  {
    ...
    position: 'Midfielder',
    avatarInitials: 'AO',
    avatarCrop: { centerX: 768, centerY: 750, size: 368 },
    cycleRegularity: 'Regular',
    trainingBackground: 'Elite',
    sleepVariability: 'Low',
    onboardingComplete: true,
  },
  {
    ...
    position: 'Defender',
    avatarInitials: 'ZM',
    avatarCrop: { centerX: 1230, centerY: 750, size: 368 },
...
export const LOAD_SCORES: Record<string, LoadScore> = {
  ...
  'aisha-okafor': {
    ...
    contextSummary: "Today's context is consistent with your recent baseline. No notable shifts this week.",
    dimensions: [
      { label: 'Recovery Capacity', arrow: 'stable', detail: 'Within your normal range' },
      { label: 'Fatigue Sensitivity', arrow: 'stable', detail: 'Consistent with baseline' },
      { label: 'Sleep Stability', arrow: 'stable', detail: 'Steady recent pattern' },
      { label: 'Context Impact', arrow: 'stable', detail: 'Minimal variation today' },
    ],
  },
  'zoe-mitchell': {
